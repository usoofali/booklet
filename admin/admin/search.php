<?php
 ...
 include('config.php');
	...
	if(mysqli_num_rows($sql) == 1){
		...
		echo "<h4 style='color:blue' align='center'>STUDENT OF USMANU DANFODIYO UNIVERSITY</h4>";
		...
		echo "<tr><td width='40%' style='color:blue'>Department</td><td>".$row['department']."</td></tr>";
