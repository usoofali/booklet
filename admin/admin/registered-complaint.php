...
<!-- fitting any device-->
    ...
    <title>Admin Registered Complaints</title>
  ...
  <body style="background-color: lightgreen" id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="#">R E G I S T E R E D...</a>
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="display.php">ALL REGISTERED COMPLAINTS </a>
            </li>
...
if ($total!==0) 
{
  while ($result=mysqli_fetch_assoc($data)) {
    ...
    <td>".$result['status']."</td>
    <td><a href='status.php?id=$result[id]'>Update</a></td>
